  ...
  const slides = [
    {
      ...
      description:
        "Quickly secure your slot with our user-friendly interface. No hassle, just a few clicks!",
    },
    {
      title: "Real-Time Availability",
      description:
        "Check availability in real-time and ensure you get the time and date you want.",
    },
    {
      title: "Exclusive Offers",
      description:
        "Enjoy special discounts and offers when you book through our platform.",
    },
  ];
    ...
    <div className="bg-gray-100">
      ...
      <Container>
        <section className="text-center bg-gray-100 p-6    h-[500px] flex justify-center items-center">
          <div className="">
            <h1 className="text-3xl font-bold text-[#41a6d4]">
              Welcome to Our Booking Platform!
            </h1>
            <p className="mt-[6px] text-gray-700">
              Secure your spot effortlessly! Book your slot now and never miss
        ...
        <section className="mt-8 bg-white py-8 rounded-[4px] ">
          <h2 className="text-2xl font-bold  text-center justify-center text-gray-800">
            ...
            <div className="overflow-hidden  h-[150px]">
              ...
              >
                {slides.map((slide, index) => (
                  ...
                  >
                    <h3 className="text-lg font-semibold text-[#41a6d4]">
                      {slide.title}
                    </h3>
        ...
        <section className="mt-12 bg-gray-100 p-6  ">
          ...
          <p className="mt-3 text-center text-gray-700">
            As a guest, you can explore our slots, view detailed availability,
            and secure bookings without signing up.
          </p>
          <div className="mt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-4 bg-white  ">
              ...
              <p className="text-gray-600">
                See what times are open and book instantly.
              </p>
            </div>
            <div className="p-4 bg-white  ">
              <h3 className="text-lg font-semibold text-[#41a6d4]">
              ...
              <p className="text-gray-600">
                Filter slots by your preferred date and time.
              </p>
            </div>
            <div className="p-4 bg-white  ">
              <h3 className="text-lg font-semibold text-[#41a6d4]">
